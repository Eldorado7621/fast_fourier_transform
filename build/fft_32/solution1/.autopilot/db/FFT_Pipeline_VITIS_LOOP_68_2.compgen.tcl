...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_OUT_TREADY { I 1 bit } data_OUT_TDATA { O 32 vector } data_OUT_TVALID { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { xout_M_real_V_address0 { O 5 vector } xout_M_real_V_ce0 { O 1 bit } xout_M_real_V_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { xout_M_imag_V_address0 { O 5 vector } xout_M_imag_V_ce0 { O 1 bit } xout_M_imag_V_q0 { I 16 vector } } \
} "
} else {
